...
const Navbar = () => {
  const linkClass = ({ isActive }) => {
    return isActive
      ? "border focus:ring-2 focus:ring-sky-400 hover:text-sky-200 text-white px-3 py-2 rounded-md"
      : "text-white transition ease-in-out duration-400 hover:text-sky-200 px-3 py-2";
  };
  return (
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="ml-4 md:ml-auto ">
              <div className="flex space-x-2">
                ...
                <NavLink to="/add-new-job" className={linkClass}>
                  Post Job
                </NavLink>
                {/* <NavLink
                  to="/register"
